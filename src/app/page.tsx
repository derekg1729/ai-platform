      ...
      <div className="relative z-10 container mx-auto px-4 pt-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-400 text-lg mb-8">
            A marketplace of action-focused AI agents.
            <br />
            Find desired agents and connect them to your apps with standardized APIs.
          </p>
        ...
        <div className="mt-16">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-semibold text-white">Recently Added Models</h2>
            <a href="/marketplace" className="text-purple-400 hover:text-purple-300 flex items-center gap-2">
              View all models
              <svg
                className="w-4 h-4"
                fill="none"
